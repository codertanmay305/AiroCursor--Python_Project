...
def detect_gesture(frame, landmark_list, processed):
    ...
    if len(landmark_list) >= 21:
        ...
        if util.get_distance([landmark_list[4], landmark_list[5]]) < 50 and util.get_angle(landmark_list[5], landmark_list[6], landmark_list[8]) > 90:
            ...
            pyautogui.scroll(30)
            cv2.putText(frame, "Scroll Up", (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 200, 255), 2)
        elif is_scroll_down(landmark_list):
            pyautogui.scroll(-30)
            cv2.putText(frame, "Scroll Down", (50, 150), cv2.FONT_HERSHEY_SIMPLEX, 1, (200, 100, 255), 2)
